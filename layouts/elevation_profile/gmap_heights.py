...
layout_wgs84 = numpy.loadtxt(join('v5.tm', 'layout_wgs84.txt'), delimiter=',')
layout_enu = numpy.loadtxt(join('v5.tm', 'layout.txt'))
...
print(size, blocks)
pickle_file = 'elevation_%i.pickle' % num_locations
