# -*- coding: utf-8 -*-
"""Script to show that there is a difference regenerating vs rotating
   the coordinates from super-station 6 to get super-station 7.

Both station 6 and 7 are generated by ports of the super-mongo scripts
and compared to the antenna files. This verify that the generation
script matches the antenna files.

Since ss6 and ss7 should really only be different by having differing
super-station rotations (?) an attempt is made to rotate ss6 to ss7
and it is found only to work for the inner station of ss7.

This is because of the way rotations and translations used to generate the
station positions don't commute and the code used to position antennas
in the super-station is written in a way where the super-station
rotation angle is tied to the other rotations and translations.
"""
import numpy
import matplotlib.pyplot as pyplot
from math import pi, cos, sin, radians, sqrt, degrees
