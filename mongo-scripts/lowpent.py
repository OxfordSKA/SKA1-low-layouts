...
if __name__ == "__main__":
    ...
    for xx in range(0, 45, 5):
        dalp = float(xx)  # Rotation angle of the entire station
        alpg = [12., 20., 24., 34., 42., 57.]  # lattice rotation angles
        # alpg = numpy.zeros(6)
        # alpg = numpy.random.uniform(0, 180, 6)
        angles = numpy.arange(0, 6) * 72.
        angles[0] = -36.
        sangles = numpy.arange(0, 6) * 72.
        sangles[0] = -36.0
        fract_jitter = 0.0
