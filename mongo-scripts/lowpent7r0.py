...
if __name__ == "__main__":
    ...
    sb7r0 = numpy.loadtxt('../ant_files/sbfile7r0.ant')
    ...
    ax.plot(sb7r0[:48*6*plot_num_stations, 0],
            sb7r0[:48*6*plot_num_stations, 1], 'x',
            markeredgecolor='r', markerfacecolor='None')
    ax.set_title('7r0: 1.5m antenna footprints')
